...
try:
    ...
    from queries import qry_get_managers, qry_get_orders_with_approaching_supplydate_and_no_requested_seria
try:
    from erpChecks.mail_body import mail_body_upcoming_supplydate
except ImportWarning:
    from mail_body import mail_body_upcoming_supplydate
